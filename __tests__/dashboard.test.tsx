...
describe('Dashboard Page Integration', () => {
  ...
  it('2. Renders the error state and triggers refetch', () => {
    ...
    const retryBtn = screen.getByRole('button', { name: /click to refresh/i })
  ...
  it('4. Renders the VideoPlayer when the event allows streaming', () => {
    ...
    // Now video should be present in the document
    // We can just assert no error happens and that our specific components load securely
    expect(screen.getByText('Event Overview')).toBeInTheDocument()
  })
})
